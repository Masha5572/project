...
<h1  class="my-5 text-center">Новые модели</h1>
<h3 class="my-5 text-center">Будьте в курсе событий</h3>
<main>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <video class="w-100" autoplay loop muted>
            <source src="../../../public/img/videoplayback.mp4" type="video/mp4" />
        </video>
    </div>
    <div class="carousel-item">
      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/fb338586282121.5d94aeb5c9de4.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://mtdata.ru/u15/photoB730/20950966234-0/original.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div class="col-md-8 col-sm-12">
      <img class="w-100" src="../../../public/img/Stuart-Weitzman-400x242.jpg">
    </div>
<div class="col-md-4 col-sm-12 text-center">
      <h2 class="my-2">"Zarfool": Кто мы?</h2>
      <p>Магазин Zarfool появился на стыке стиля и современных технологий. Вдохновляющие коллекции и безупречный сервис помогли нам завоевать признание с первых дней работы. Посетите наш веб-сайт и ознакомьтесь с новым каталогом. Если у вас есть вопрос или вам нужна консультация, напишите или позвоните нам. Мы будем рады помочь. Удачных покупок.</p>
    </div>
</div>
  </div>
...
<div class="container my-5 justify-content-center">
    <div class="row">
  <div class="col-md-4 col-sm-12 text-center">
      <h2>CRUISE COLOR SPLASH</h2>
      <h3>ВЛАДЕТЬ ЦЕНТРОМ ВНИМАНИЯ</h3>
      <p>В этом сезоне все о возвращении к оптимизму через кричащие цвета и пропорции. Добавьте немного вибрации в свой гардероб!</p>
      <a class="btn btn-light" href="{{'shop/girls'}}" role="button">В Магазин</a>
  </div>
    <div class="col-md-8 col-sm-12">
        <img class="w-100" src="../../../public/img/0o4nfOoHIig.jpg">
    </div>
</div>
</div>
    ...
    <div class="container my-3">
        <div class="row  justify-content-center">
                ...
                <div class="card me-4" style="width: 18rem;">
                    <a class="link-secondary" href="#"><img src="../../../public/storage/{{$randProduct->img}}" width="100%" class="img-fluid rounded-start" alt="...">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title text-center"> <a role="button" class="btn btn-light card-title mb-3 link">{{$randProduct->name}}</a></h5>
                        <a href="#" class="btn btn-light text-center">Цена: {{$randProduct->price}}</a>
                        <a style="font-size: 2em" class="link-secondary" href="{{route('shop/cart',['id'=>$randProduct->id])}}">
                             <i class="bi bi-bag-heart"></i>
                        </a>
...
<div class="col-sm">
     <h1>Контакты</h1>
     <h3>Федюнинского 56</h3>
     <h3>pashkovamariya0@gmail.com</h3>
     <h3>+79088796285</h3>
         </div>
<div class="col-sm">
    <iframe height="500px" class="w-100" src="https://yandex.ru/map-widget/v1/?um=constructor%3Aebc3fba3b7619789c3dc9af19cce0489a8c3d8d9f7ded055883f20570946bb07&amp;source=constructor"  frameborder="0"></iframe>
  </div>
  </div>
</div>
