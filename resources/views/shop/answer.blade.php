          ...
          <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav w-100 justify-content-center">
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="{{route('shop/blog')}}">Blog</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="{{route('shop/answer')}}">Questions and answers</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="{{route('shop/girls')}}">Shop</a>
                      </li>
                      ...
                      <li class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              ...
                              <li><a class="dropdown-item" href="Boy.html">Men</a></li>
...
<main>
    ...
    <div class="container my-4">
        <div class="row">
<div class="col">
    <h3 class="text-center">КОГДА БУДЕТ ОТПРАВЛЕН МОЙ ЗАКАЗ?</h3>
    <p class="text-center">Мы стремимся отправить заказы в течение 3 рабочих дней после размещения заказа. Мы стараемся следить за тем, чтобы запасы точно обновлялись на нашем сайте, но если товара нет на складе, мы уведомим вас об этом как можно скорее по электронной почте.</p>
    <h3 class="text-center my-3">КАК ДОЛГО ПРОСЛУЖАТ ВАШИ ПРОДУКТЫ?</h3>
    <p class="text-center">Все наши продукты отображают символ PAO (Period After Opening), который сообщает вам, сколько месяцев продукт годен для использования после его открытия.
        Хотя наши продукты упакованы в биофотонное стекло, лучше всего хранить их вдали от прямых солнечных лучей, тепла и влажности, чтобы обеспечить свежесть и эффективность.</p>
</div>
               <div class="col">
                   <h3 class="text-center my-3">У меня свой интернет магазин могу ли я воспользоваться вашим материалом (фото модели)?</h3>
                   <p class="text-center">Если вы являетесь нашим клиентом, то можно.</p>
                   <h3 class="text-center my-3">Безопасно ли заказывать на Вашем сайте?</h3>
                   <p class="text-center">Одна из самых безопасных онлайн-систем применяется на нашем сайте для защиты вашей личной информации от несанкционированного использования.

                       Мы являемся членом BBB (Better Business Bureau) - некоммерческой организации, ориентированной на обеспечение справедливых и равноправных сделок между потребителями и бизнесом.

                       Мы также используем технологию secure socket layer (SSL), где любая личная информация, полученная через наш веб-сайт, является частной и поддерживается в безопасной и защищенной среде и никогда не будет передана третьим лицам.</p>
