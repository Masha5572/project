          ...
          <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav w-100 justify-content-center">
                      <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="{{route('shop/main')}}">Главная</a>
                      </li>
                      <li class="nav-item">
                  ...
                  <form class="d-flex" method="get" action="{{route('shop/search')}}">
                              <input type="text" class="form-control me-2" id="s" name="s" placeholder="Я ищу...">
    ...
    <div class="container my-4 justify-content-center">
        <div class="row">
            ...
            <div class="card mt-3 me-4" style="width: 15rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title text-center"> <a  href="#" role="button" class="card-title mb-3 link-dark"><a class="btn btn-light" role="button" href="{{route('shop/product-details',['name'=>$product->name])}}">{{$product->name}}</a></a></h5>
                    <a href="#" class="btn btn-light text-center">Цена: {{$product->price}}</a>
