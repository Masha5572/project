                ...
                <x-auth-card>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <x-input   id="name" class="block mt-1 w-full form-control  rounded-pill" type="text" name="name" :value="old('name')" />
                            @error('name')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="password_confirmation" class="block mt-1 w-full form-control  rounded-pill"
                                     type="password"
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-button class="ml-4 bg-dark  rounded-pill">
